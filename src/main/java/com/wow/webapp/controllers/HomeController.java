...
public class HomeController {
	...
	public ModelAndView diagnostics(){
		logger.debug("diagnostics get start");
		ModelAndView mv = new ModelAndView("diagnostics");
		return mv;
	}
	...
	@RequestMapping(value = "/HomeCare", method = RequestMethod.GET)
	public ModelAndView HomeCare(){
		logger.debug("HomeCare get get start");
		ModelAndView mv = new ModelAndView("HomeCare");
		return mv;
	}
	@RequestMapping(value = "/HomeHealth", method = RequestMethod.GET)
	public ModelAndView HomeHealth(){
		logger.debug("HomeHealth get get start");
		ModelAndView mv = new ModelAndView("HomeHealth");
		return mv;
	}
	@RequestMapping(value = "/PreEmploymentChecks", method = RequestMethod.GET)
	public ModelAndView PreEmploymentChecks(){
		logger.debug("PreEmploymentChecks get get start");
		ModelAndView mv = new ModelAndView("PreEmploymentChecks");
		return mv;
	}
